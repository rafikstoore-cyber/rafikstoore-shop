          ...
          <div className="flex h-16 items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <details className="relative lg:hidden">
                <summary
                  aria-label="القائمة"
                  className="list-none cursor-pointer rounded-xl p-2.5 transition hover:bg-gray-100"
                >
                  <Menu size={21} />
                </summary>

                <div className="absolute left-0 top-12 z-[100] w-60 rounded-2xl border border-gray-200 bg-white p-2 shadow-2xl">

                  <a
                    href="/"
                    className="block rounded-xl px-4 py-3 text-right text-sm font-semibold transition hover:bg-gray-100"
                  >
                    🏠 الرئيسية
                  </a>
                  ...
                  <a
                    href="/admin"
                    className="block rounded-xl bg-gray-900 px-4 py-3 text-right text-sm font-bold text-white transition hover:bg-[#f97316]"
                  >
                    📊 Dashboard
                  </a>
                  ...
                  <a
                    href="/login"
                    className="mt-1 block rounded-xl px-4 py-3 text-right text-sm font-semibold transition hover:bg-gray-100"
                  >
                    👤 تسجيل الدخول
                  </a>
                </div>
      ...
      <section className="border-b border-gray-100 bg-white">
        <div className="mx-auto grid max-w-7xl grid-cols-2 divide-x divide-gray-100 px-4 py-6 sm:grid-cols-4">
          ...
          <div className="flex items-center justify-center gap-3 border-t border-gray-100 px-3 py-3 text-center sm:border-t-0 sm:text-right">
            <ShieldCheck
              className="hidden text-[#f97316] sm:block"
              size={24}
            />
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
          ...
          <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
            ...
            <div className="flex flex-wrap gap-5 text-xs font-medium text-gray-500">
              ...
              <a
                href="/admin"
                className="font-bold hover:text-[#f97316]"
              >
                Dashboard
              </a>
            </div>
