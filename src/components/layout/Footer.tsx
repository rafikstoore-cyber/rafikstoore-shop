        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://wa.me/212726234905" target="_blank" rel="noopener noreferrer">
              <MessageCircle className="w-5 h-5 text-rafik-cream hover:text-rafik-gold transition-colors" />
            </a>
            <a href="https://instagram.com/rafikstoore" target="_blank" rel="noopener noreferrer">
              <Instagram className="w-5 h-5 text-rafik-cream hover:text-rafik-gold transition-colors" />
            </a>
            <a href="mailto:rafikstoore@gmail.com">
              <Mail className="w-5 h-5 text-rafik-cream hover:text-rafik-gold transition-colors" />
            </a>
          </div>
        </div>
      </div>

      <div className="border-t border-rafik-cream/20 py-4 text-center text-xs text-rafik-cream/60">
        © {new Date().getFullYear()} RAFIK STORE. جميع الحقوق محفوظة.
      </div>
    </footer>
  );
}
